        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <form method="POST" action="{{ route('books.store') }}">
            ...
            <section class="mt-4">
              ...
              <x-text-input id="isbn" class="block mt-1 w-full" type="isbn" name="isbn" :value="old('isbn')"
            ...
            <section class="mt-4">
              ...
              <x-text-input id="published_at" class="block mt-1 w-full" type="published_at" name="published_at" :value="old('published_at')"
            ...
            <section class="mt-4">
              ...
              <x-text-input id="summary" class="block mt-1 w-full" type="summary" name="summary" :value="old('summary')"
